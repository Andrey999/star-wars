import { SWAPI_PEOPLE, IMAGE_PERSON_URL, IMAGE_EXTENSION, API_PEOPLE, SINGLE_PEOPLE } from '../constants/api'

export const getUrlId = (url: string, category: any) => {
...
export const getPeopleImage = (id: any) => `${IMAGE_PERSON_URL}/${id + IMAGE_EXTENSION}`
